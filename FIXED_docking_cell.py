...
# =============================================================================
# 
# Copy this entire code into the docking cell in your notebook.
# This includes complete AutoDock4 workflow with GPF, AutoGrid4, DPF, and docking.
    ...
    with open(pdbqt_path, 'r') as f:
        for line in f:
            if line.startswith(('ATOM', 'HETATM')):
                ...
                if len(parts) >= 12:
                    atom_type = parts[-1]
                    # All valid AutoDock4 atom types
                    valid_types = [
                        'A',   # Aromatic carbon
                        'C',   # Carbon
                        'N',   # Nitrogen
                        ...
                        'S',   # Sulfur
                        'SA',  # Sulfur acceptor
                        'H',   # Hydrogen (non-polar)
                        'HD',  # Hydrogen donor (polar)
                        'HS',  # Hydrogen bonded to sulfur
                        'P',   # Phosphorus
                        'F',   # Fluorine
                        'Cl',  # Chlorine
                        'Br',  # Bromine
...
spacing {spacing:.4f}
receptor_types A C HD N NA NS OA OS SA S
