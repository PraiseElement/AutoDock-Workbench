...
# FIXED: Helper function to safely compute magnitude for hydrogen placement
def safe_mag(v, b_length):
    """Safely compute magnitude, returning b_length if vector is zero-length"""
    mag_sq = v[0] * v[0] + v[1] * v[1] + v[2] * v[2]
    if mag_sq == 0:
        return b_length  # Return default value to avoid division by zero
    return b_length / math.sqrt(mag_sq)
...
class AddHydrogens:
    ...
    def add_sp3_N_hydrogen(self, atom, b_length, addedH=None):
        ...
        mag = safe_mag(h1, b_length)  # FIXED: use safe_mag
    ...
    def add_tertiary_hydrogen(self, atom, b_length):
        ...
        mag = safe_mag(s, b_length)  # FIXED: use safe_mag
    ...
    def add_methylene_hydrogens(self, atom, b_length, addedH=None):
        ...
        mag = safe_mag(h2, b_length)  # FIXED: use safe_mag
